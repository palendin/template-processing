...
class Run_assay(QWidget):
    def __init__(self, parent = None):
        ...
        # create a layout
        self.vbox = QVBoxLayout() # vertical placement
        self.instruction_text_layout = QHBoxLayout() # horizontal placement
        
        # place widgets inside the window
        self.label = QLabel("Calculates Hydroxyproline Concentration")
        self.label.setFont(QFont('Arial', 20))
        
        # set the main layout of our window as vertical
    ...
    def ButtonUI(self):
        ...
        self.instruction = QLabel('Enter a HP experiment ID:')
        ...
        # pack the widgets in our vbox vertical layout
        self.vbox.addWidget(self.label)
        
        # use horizontal layout for text instruction and inputbox
        self.instruction_text_layout.addWidget(self.instruction)  
        self.instruction_text_layout.addWidget(self.input_box)
        # overlay the horizontal layout to vbox vertical layout
        self.vbox.addLayout(self.instruction_text_layout)
        
        # add other widgets in vbox vertical layout
